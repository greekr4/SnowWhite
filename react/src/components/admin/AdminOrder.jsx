      ...
      <S.MainLayout>
        <S.AdminWrapper>
          ...
          <S.Btn
            ...
            onClick={() => {
              const count = selectedItem.filter((el) => el === true).length;
              if (count !== 1) {
                alert("배송중 처리는 1개만 선택해주세요");
                return false;
              }
          ...
          <S.AdminInfoBox>
            ...
            <div onClick={() => statusFillter(1)}>
              ...
              <span className="number">
                {
                  initOrderlist_frist.filter((el) => el.ORDER_STATUS === 1)
                    .length
                }
              </span>
            </div>
            <div onClick={() => statusFillter(2)}>
              ...
              <span className="number">
                {
                  initOrderlist_frist.filter((el) => el.ORDER_STATUS === 2)
                    .length
                }
              </span>
            </div>
            <div onClick={() => statusFillter(3)}>
              ...
              <span className="number">
                {
                  initOrderlist_frist.filter((el) => el.ORDER_STATUS === 3)
                    .length
                }
              </span>
            </div>
            <div onClick={() => statusFillter(4)}>
              ...
              <span className="number">
                {
                  initOrderlist_frist.filter((el) => el.ORDER_STATUS === 4)
                    .length
                }
              </span>
            </div>
            <div onClick={() => statusFillter(5)}>
              ...
              <span className="number">
                {
                  initOrderlist_frist.filter((el) => el.ORDER_STATUS === 5)
                    .length
                }
              </span>
            </div>
            <div onClick={() => statusFillter(9)}>
              ...
              <span className="number">
                {
                  initOrderlist_frist.filter((el) => el.ORDER_STATUS === 9)
                    .length
                }
              </span>
            </div>
        ...
        <DialogActions>
          <Button
            onClick={() => {
              ...
              axios.put(process.env.REACT_APP_DB_HOST + "/api/admin/order", {
                order_sid: order_sids,
                field: "ORDER_STATUS",
                order_status: 4,
                logis_nm: logisNm,
