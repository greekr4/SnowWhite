...
const Leaflet_detail = ({
  ...
  useEffect(() => {
    ...
    copyOptionList.리플릿.코팅 = coatingDetail;
    copyOptionList.리플릿.귀도리 = rounding;
    copyOptionList.리플릿.오시 = osiDetail;
    copyOptionList.리플릿.미싱 = missingDetail;
    copyOptionList.리플릿.타공 = `${punchingArea} ${punchingQty}`;
