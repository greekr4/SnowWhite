...
const Booklet_detail = ({
  ...
  useEffect(() => {
    ...
    copyOptionList.책자.표지코팅 = coatingDetail;
    copyOptionList.책자.귀도리 = rounding;
    copyOptionList.책자.오시 = osiDetail;
    copyOptionList.책자.미싱 = missingDetail;
    copyOptionList.책자.타공 = `${punchingArea} ${punchingQty}`;
    ...
    <>
      ...
      {SelectOptions.책자.표지코팅 && (
        <Box sx={{ display: "flex", padding: "6px 0" }}>
          ...
          >
            <Box sx={{ lineHeight: "45px" }}>표지코팅</Box>
            <Box
              sx={{
                lineHeight: "20px",
                height: "20px",
