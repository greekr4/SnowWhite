...
const Flyer_detail = ({
  ...
  useEffect(() => {
    ...
    copyOptionList.전단지.코팅 = coatingDetail;
    copyOptionList.전단지.귀도리 = rounding;
    copyOptionList.전단지.오시 = osiDetail;
    copyOptionList.전단지.미싱 = missingDetail;
    copyOptionList.전단지.타공 = `${punchingArea} ${punchingQty}`;
