...
const NameCard_Premium_detail = ({
  ...
  useEffect(() => {
    ...
    copyOptionList.고급지.귀도리 = rounding;
    copyOptionList.고급지.오시 = osiDetail;
    copyOptionList.고급지.미싱 = missingDetail;
    copyOptionList.고급지.타공 = `${punchingArea} ${punchingQty}`;
...
export default NameCard_Premium_detail;
