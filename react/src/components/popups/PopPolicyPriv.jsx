            ...
            <S.Pop_form>
              ...
              <S.Pop_Policy_Wrap>
                <S.Pop_Policy_Content>
                  ...
                  <p>
                    2. 회사는 제1항에 따라 본 방침을 공개하는 경우 글자 크기,
                    색상 등을 활용하여 이용자가 본 방침을 쉽게 확인할 수 있도록
                    합니다.
                  </p>
                  <h1>제4조(본 방침의 변경)</h1>
                  <p>
                  ...
                  <p>
                    2. 회사는 제1항에 따라 본 방침을 개정하는 경우 다음 각 호
                    하나 이상의 방법으로 공지합니다.
                  </p>
                  ...
                  <p>
                    3. 회사는 제2항의 공지는 본 방침 개정의 시행일로부터 최소
                    7일 이전에 공지합니다. 다만, 이용자 권리의 중요한 변경이
                    있을 경우에는 최소 30일 전에 공지합니다.
                  </p>
                  <h1>제5조(개인정보 수집 방법)</h1>
                  <p>
                  ...
                  <p>
                    2. 어플리케이션 등 회사가 제공하는 홈페이지 외의 서비스를
                  ...
                  <p>
                    4. 법령 및 회사 약관을 위반하는 회원에 대한 이용 제한 조치,
                    부정 이용 행위를 포함하여 서비스의 원활한 운영에 지장을 주는
                    행위에 대한 방지 및 제재를 위한 경우
                  </p>
                  <h1>제7조(개인정보의 보유 및 이용기간)</h1>
                  <p>
                  ...
                  <h1>제8조(법령에 따른 개인정보의 보유 및 이용기간)</h1>
                  <p>
                    회사는 관계법령에 따라 다음과 같이 개인정보를 보유 및
                    이용합니다.
                  </p>
                  <p>
                    1. 전자상거래 등에서의 소비자보호에 관한 법률에 따른
                    보유정보 및 보유기간
                  </p>
                  <p style={{ paddingLeft: "1em" }}>
                  ...
                  <p>
                    2. 회사는 전항에도 불구하고 수신자가 수신거부의사를
                    표시하거나 사전 동의를 철회한 경우에는 영리목적의 광고성
                    정보를 전송하지 않으며 수신거부 및 수신동의 철회에 대한 처리
                    결과를 알립니다.
                  </p>
                  <p>
                    3. 회사는 오후 9시부터 그다음 날 오전 8시까지의 시간에
                    전자적 전송매체를 이용하여 영리목적의 광고성 정보를 전송하는
                    경우에는 제1항에도 불구하고 그 수신자로부터 별도의 사전
                    동의를 받습니다.
                  </p>
                  <p>
                    4. 회사는 전자적 전송매체를 이용하여 영리목적의 광고성
                    정보를 전송하는 경우 다음의 사항 등을 광고성 정보에
                    구체적으로 밝힙니다.
                  </p>
                  <p style={{ paddingLeft: "1em" }}>가. 회사명 및 연락처</p>
                  <p style={{ paddingLeft: "1em" }}>
                    나. 수신 거부 또는 수신 동의의 철회 의사표시에 관한 사항의
                    표시
                  </p>
                  <p>
                    5. 회사는 전자적 전송매체를 이용하여 영리목적의 광고성
                    정보를 전송하는 경우 다음 각 호의 어느 하나에 해당하는
                    조치를 하지 않습니다.
                  </p>
                  <p style={{ paddingLeft: "1em" }}>
                  ...
                  <h1>
                    제14조(개인정보 자동 수집 장치의 설치·운영 및 거부에 관한
                    사항)
                  </h1>
                  <p>
                    ...
                    서버(http)가 이용자의 웹브라우저(PC 및 모바일을 포함)에게
                    보내는 소량의 정보이며 이용자의 저장공간에 저장되기도
                    합니다.{" "}
                  </p>
                  <p>
                  ...
                  <h1>제15조(쿠키 설치 허용 지정 방법)</h1>
                  <p>
                    웹브라우저 옵션 설정을 통해 쿠키 허용, 쿠키 차단 등의 설정을
                    할 수 있습니다.
                  </p>
                  <p>
                    1. Edge : 웹브라우저 우측 상단의 설정 메뉴{" > "}쿠키 및
                    사이트 권한{" > "}쿠키 및 사이트 데이터 관리 및 삭제
                  </p>
                  <p>
                    2. Chrome : 웹브라우저 우측 상단의 설정 메뉴{" > "}개인정보
                    및 보안{" > "}쿠키 및 기타 사이트 데이터
                  </p>
                  <p>
                    3. Whale : 웹브라우저 우측 상단의 설정 메뉴{" > "}개인정보
                    보호
                    {" > "}쿠키 및 기타 사이트 데이터
                  </p>
                  <h1>제16조(권익침해에 대한 구제방법)</h1>
                  <p>
                  ...
                  <br />
                  <h1>부칙</h1>
                  <p>제1조 본 방침은 2024.05.01.부터 시행됩니다.</p>
                </S.Pop_Policy_Content>
              </S.Pop_Policy_Wrap>
              <S.Pop_Button_Wrap>
